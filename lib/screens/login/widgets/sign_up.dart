...
import 'package:flutter_samples/screens/login/widgets/custom_snack_bar.dart';
...
class _SignUpState extends State<SignUp> {
  ...
  void _toggleSignupConfirm() {
    setState(() => _obscureTextConfirmPassword = !_obscureTextConfirmPassword);
  }
                    ...
                    children: <Widget>[
                      Padding(
                        ...
                        child: TextField(
                          ...
                          onSubmitted: (_) => _focusNodeEmail.requestFocus(),
                        ),
                      ),
                      Container(
                        width: 250.0,
