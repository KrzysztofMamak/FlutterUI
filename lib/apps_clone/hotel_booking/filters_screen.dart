...
import 'package:flutter_samples/apps_clone/hotel_booking/popular_filter_list.dart';
      ...
      noList.add(
        Material(
          ...
          child: InkWell(
            ...
            onTap: () => setState(() => checkAppPosition(i)),
            child: Padding(
  ...
  Widget distanceViewUI() {
    return Column(
      ...
      children: <Widget>[
        ...
        SliderView(
          distValue: distValue,
          onChangedListValue: (value) => distValue = value,
        ),
        const SizedBox(height: 8),
      ],
    );
              ...
              children: <Widget>[
                Material(
                  ...
                  child: InkWell(
                    borderRadius: const BorderRadius.all(Radius.circular(4.0)),
                    onTap: () =>
                        setState(() => date.isSelected = !date.isSelected),
                    child: Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: Row(
                        children: <Widget>[
