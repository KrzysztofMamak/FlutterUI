...
import 'package:flutter_samples/apps_clone/hotel_booking/calendar_popup_view.dart';
import 'package:flutter_samples/apps_clone/hotel_booking/filters_screen.dart';
import 'package:flutter_samples/apps_clone/hotel_booking/hotel_list_data.dart';
import 'package:flutter_samples/apps_clone/hotel_booking/hotel_list_view.dart';
  ...
  Widget getListUI() {
    return Container(
      ...
      child: Column(
        children: <Widget>[
          Container(
            height: MediaQuery.of(context).size.height - 156.0 - 50.0,
