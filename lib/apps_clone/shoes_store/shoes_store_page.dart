...
import 'package:flutter_samples/apps_clone/shoes_store/shoes_store_details_page.dart';
import 'package:vector_math/vector_math.dart' as vector;

const kBottomBackgroundColor = Color(0xFFF1F2F7);
const brands = ['Nike', 'Adidas', 'Jordan', 'Puma', 'Reebok'];
const kMarginSide = 14.0;
const kLeftItemSeparator = const SizedBox(width: 30);
...
class _ShoesStorePageState extends State<ShoesStorePage> {
  ...
  Widget _buildBottom(BuildContext context) {
    ...
    return Container(
      ...
      child: Padding(
        padding: const EdgeInsets.symmetric(horizontal: kMarginSide),
        child: Column(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Column(
        children: <Widget>[
          Padding(
            padding: const EdgeInsets.all(kMarginSide),
            child: _buildHeader(),
          ),
          Expanded(
            child: Stack(
